...
import { getEducationTL,getEducationTeam,Assign } from "../../actions/educationTL";

const AllCases = ({getEducationTL,getEducationTeam,education,team,Assign}) => {
...
AllCases.propTypes = {
getEducationTL:PropTypes.func.isRequired,
getEducationTeam:PropTypes.func.isRequired,
Assign:PropTypes.func.isRequired,
}

const mapStateToProps = state =>({
    education: state.educationTL.education,
  team: state.educationTL.team,
})

export default connect(mapStateToProps,{getEducationTL,getEducationTeam,Assign})(AllCases)
