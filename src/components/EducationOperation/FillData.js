...
import {
saveEducation,
saveInsuffEducation,getVendorState,assignVendorEDU
} from "../../actions/educationOperation";
import { withRouter } from "react-router-dom";
import { RegionDropdown } from "react-country-region-selector";
const FillData = ({location,history,saveEducation,saveInsuffEducation,getVendorState,vendor,assignVendorEDU}) => {
    ...
    setFormData({
      ...
      yearOfPassing:
        location.state && location.state.yearOfPassing
          ...
          : "",
      recognizedUnderAuthority: location.state && location.state.recognizedUnderAuthority ? location.state.recognizedUnderAuthority : "",
      grade: location.state && location.state.grade ? location.state.grade : "",
      verifierDetail: location.state && location.state.verifierDetail ? location.state.verifierDetail : "",
      additionalComment: location.state && location.state.additionalComment ? location.state.additionalComment : "",
      verificationMode: location.state && location.state.verificationMode ? location.state.verificationMode : "",
      statusOfResult: location.state && location.state.statusOfResult ? location.state.statusOfResult : "",
      verifierDesignation: location.state && location.state.verifierDesignation ? location.state.verifierDesignation : "",
      verifiedBy: location.state && location.state.verifiedBy ? location.state.verifiedBy : "",
      genuineDocument: location.state && location.state.genuineDocument ? location.state.genuineDocument : "",
...
export default connect(mapStateToProps, {saveEducation,saveInsuffEducation,getVendorState,assignVendorEDU})(withRouter(FillData));
