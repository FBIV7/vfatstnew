...
import FillData from "../InitiateRoute/FillData";
import CDFform from "../InitiateRoute/CDFform";
import InsuffClear from "../InitiateRoute/InsuffClear";
import Education from "../InitiateRoute/Education";
      ...
      <div class="flex flex-wrap bg-gray-100 w-full h-screen">
        ...
        <div class="w-9/12">
          <Switch>
            ...
            <PrivateRoute exact path="/cdf" component={CDFform} />
            <PrivateRoute exact path="/insuffclear" component={InsuffClear} />
            <PrivateRoute exact path="/educationcdf">
              <Education />
            </PrivateRoute>
...
SideBarInitiation.propTypes = {
  logout: PropTypes.func.isRequired,
};

export default connect(null, { logout })(SideBarInitiation);
