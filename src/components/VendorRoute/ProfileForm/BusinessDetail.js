...
const BusinessDetail = ({
  ...
  return (profile&&profile.isBusiness&&profile.isBusiness === "wait" ? <div> Under verification</div>:
                    ...
                    <div class="flex mx-auto  justify-center bg-grey-lighter">
                      <label class="w-64 h-44 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-gray-900">
                        {loading || !profile.agreement_img ? (
                          ...
                          <img
                            src={profile.statutarydetails.gst}
                            className="w-64 h-full"
                          />
                        )}
                        <input
                      ...
                      <label class="w-64 h-44 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-gray-900">
                        {loading || !profile.agreement_img ? (
                          agreement === "" ? (
                            ...
                            <img
                              src={URL.createObjectURL(agreement)}
                              className="w-64 h-full"
                            />
                          )
                        ) : (
                          <img
                            src={profile.agreement_img}
                            className="w-64 h-full"
                          />
                        )}
                        <input
...
BusinessDetail.propTypes = {
  createVendorBusiness: PropTypes.func.isRequired,
  getVendorProfile: PropTypes.func.isRequired,
  updateVendorImage:PropTypes.func.isRequired,
};
