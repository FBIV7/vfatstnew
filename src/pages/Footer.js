                    ...
                    <div class="sm:flex sm:mt-8">
                        <div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-evenly">
                            <div class="flex flex-col">
                                <span class="font-bold text-gray-700 uppercase mb-2">Quick Links</span>
                                <span class="my-2"><a href="#" class="fontServ  text-md hover:text-blue-500">Rating & Review</a></span>
                            ...
                            <div class="flex flex-col">
                                <span class="font-bold text-gray-700 uppercase mt-4 md:mt-0 mb-2">Terms & Policy</span>
                                <span class="my-2"><a href="#" class=" fontServ text-md hover:text-blue-500">Terms and Conditions</a></span>
